                        ...
                        <div class="card-body card-block">
                            ...
                            <div id="pay-invoice">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <form action="{{ route('projectsUpdate', $dataProjects->id) }}" method="post"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group has-success">
                                            <label for="cc-name" class="control-label mb-1">Title</label>
                                            <input id="cc-name" name="title" type="text"
                                                class="form-control cc-name valid" value="{{ $dataProjects->title }}"
                                                >
                                        </div>
                                        <div class="form-group">
                                            <label for="cc-number" class="control-label mb-1">Description</label>
                                            <textarea id="cc-number" name="description" type="tel" class="form-control" >{{ $$dataProjects->description }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                <input id="cc-name" name="image" type="text"
                                                class="form-control cc-name valid mt-2"
                                                >
                                            </div>
                                        </div>
                                        <div class="form-group has-success">
                                            ...
                                            <input id="cc-name" name="link_github" type="text"
                                                class="form-control cc-name valid" value="{{ $dataProjects->link_github }}"
                                                >
                                        </div>
                                        <div class="form-group has-success">
                                            <label for="cc-name" class="control-label mb-1">Link Web</label>
                                            <input id="cc-name" name="link_web" type="text"
                                                class="form-control cc-name valid" value="{{ $dataProjects->link_web }}"
                                                >
                                        </div>
